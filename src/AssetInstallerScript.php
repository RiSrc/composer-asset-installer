<?php
/**
 * This file is part of the 'Composer Asset Installer' package.
 *
 * For the full copyright and license information, please view the LICENSE
 * file that was distributed with this source code.
 *
 * @author    Jens Richter <jens.richter@risrc.de>
 * @copyright Copyright (c) 2016, Jens Richter
 */

namespace RiSrc\Composer\Scripts;
...
/**
 * Class AssetInstallerScript
 *
 * @package RiSrc\Composer\Scripts
 */
class AssetInstallerScript
{
    /**
